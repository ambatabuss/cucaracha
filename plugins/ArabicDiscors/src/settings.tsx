    ...
    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 10 }}>
      <Wrap {...wrapProps}>
        <TableRowGroup title="إعدادات التعريب العامة">
          <TableSwitchRow
            label="تفعيل التعريب"
            subLabel="تحويل واجهة ديسكورد إلى اللغة العربية عبر مطابقة النصوص"
          ...
          />
          <TableSwitchRow
            label="دعم اتجاه الواجهة RTL (تجريبي BETA)"
            subLabel="قد يسبب انزياح بعض العناصر أو الأيقونات في شاشات معينة، جرّبه بحذر"
        ...
        <TableRowGroup title="أدوات التطوير">
          <TableSwitchRow
            ...
            subLabel="طباعة أي نص إنجليزي ظاهر في التطبيق لم يجد ترجمة، لمساعدتك على إضافته"
